...
import (
	...
	mock2 "vehicle-sharing-go/internal/inventory/vehicle/command/mock"
...
type createCarUnitSuite struct {
	...
	now                 func() time.Time
	mockCarRepo         *mock2.MockCarRepository
	mockTxSession       *mock2.MockTransactionalSession
...
func (s *createCarUnitSuite) SetupTest() {
	...
	s.mockCarRepo = mock2.NewMockCarRepository(s.mockCtrl)
	s.mockTxSession = mock2.NewMockTransactionalSession(s.mockCtrl)
