...
import (
	...
	mock2 "vehicle-sharing-go/internal/inventory/vehicle/projection/mock"
)
...
type carProjectorUnitSuite struct {
	...
	vinDecoder    *mock2.MockVINDecoder
	carRepo       *mock2.MockCarRepository
...
func (s *carProjectorUnitSuite) SetupTest() {
	...
	s.vinDecoder = mock2.NewMockVINDecoder(s.mockCtrl)
	s.carRepo = mock2.NewMockCarRepository(s.mockCtrl)
